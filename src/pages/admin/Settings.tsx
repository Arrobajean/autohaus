...
const Settings = () => {
  ...
  const getUserName = () => {
    ...
    return userProfile?.displayName || user?.displayName || user?.email?.split('@')[0] || 'Usuario';
  };
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
          ...
          <CardContent className="space-y-4 px-4 sm:px-6 pb-4 sm:pb-6">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pb-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                {userProfile?.role && (
                  <span className={`inline-block mt-1 px-2 py-0.5 rounded-full text-[10px] sm:text-xs ${
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                <Label htmlFor="displayName" className="text-gray-200 text-xs sm:text-sm">
                  Nombre de Usuario
                </Label>
                <Input
                  id="displayName"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-gray-200 flex items-center gap-2 text-xs sm:text-sm">
        ...
        <Card className="bg-[#1a1a1a] border-[#2a2a2a]">
          ...
          <CardContent className="space-y-4 px-4 sm:px-6 pb-4 sm:pb-6">
            <div className="space-y-3">
              <div className="space-y-2">
                <Label htmlFor="currentPassword" className="text-gray-200 text-xs sm:text-sm">
                  Contraseña Actual
                </Label>
                <Input
                  id="currentPassword"
              ...
              <div className="space-y-2">
                <Label htmlFor="newPassword" className="text-gray-200 text-xs sm:text-sm">
                  Nueva Contraseña
                </Label>
                <Input
                  id="newPassword"
              ...
              <div className="space-y-2">
                <Label htmlFor="confirmPassword" className="text-gray-200 text-xs sm:text-sm">
              ...
              <Button onClick={handleSave} variant="outline" className="w-full border-[#2a2a2a] text-gray-200 hover:bg-[#2a2a2a] text-xs sm:text-sm">
      ...
      <Card className="bg-[#1a1a1a] border-[#2a2a2a]">
        <CardHeader className="px-4 sm:px-6 pt-4 sm:pt-6">
          <CardTitle className="text-white text-base sm:text-lg">Configuración General</CardTitle>
          <CardDescription className="text-gray-400 text-xs sm:text-sm">
            Preferencias y opciones del sistema
          </CardDescription>
        </CardHeader>
