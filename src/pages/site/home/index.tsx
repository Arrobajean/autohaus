...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ backgroundColor: "#F5F4F2" }}>
      {/* Hero Section */}
      <section className="relative h-[100vh] md:h-[130vh] flex items-start justify-center bg-slate-900 text-white overflow-hidden pt-[20vh] md:pt-[18vh]">
        ...
        <motion.div 
          ...
          style={{
            ...
            y: useTransform(scrollYProgress, [0, 0.5], [
              isMobile ? -20 : -80, 
              isMobile ? -100 : -260
            ])
          }}
        ...
        >
          ...
          >
            ...
            <span className="hidden md:inline"> </span>de confianza
            <br className="md:hidden" />
            <span className="hidden md:inline"> </span>en Madrid
          </motion.h1>
          <motion.h2
          ...
          >
            ...
            <br className="md:hidden" />
            <span className="hidden md:inline"> </span>de vehículos de lujo diseñados
            <br />
            <span className="md:inline"> </span>para el rendimiento.
          </motion.h2>
          <motion.div
      ...
      {/* CTA Section */}
      <section className="py-12 md:py-20 px-4 md:px-8" style={{ backgroundColor: "#F5F4F2" }}>
          ...
          <div className="text-center mb-10 md:mb-16">
            ...
            >
              <span className="md:hidden">
                Visita nuestro showroom hoy o explora<br />
                nuestro inventario online para<br />
                encontrar el vehículo perfecto para tu estilo de vida.
              </span>
              <span className="hidden md:inline">
                <div>Visita nuestro showroom hoy o explora nuestro inventario online para encontrar</div>
